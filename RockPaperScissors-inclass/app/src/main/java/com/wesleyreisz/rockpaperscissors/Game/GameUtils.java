...
public class GameUtils {
    ...
    public static String evaluateWinner(Integer playerSelectedChoice, Integer computerSelectedChoice) {
        ...
        */
        ...
        if(playerSelectedChoice.equals(btnRock)&& computerSelectedChoice.equals(btnScissors)){
            return GameUtils.BEATS;
        }

        if(playerSelectedChoice.equals(btnRock)&& computerSelectedChoice.equals(btnRock)){
            return GameUtils.TIES;
        }

        if(playerSelectedChoice.equals(btnRock)&& computerSelectedChoice.equals(btnPaper)){
            return GameUtils.LOSES_TO;
        }

        if(playerSelectedChoice.equals(btnScissors)&& computerSelectedChoice.equals(btnPaper)){
            return GameUtils.BEATS;
        }

        if(playerSelectedChoice.equals(btnScissors)&& computerSelectedChoice.equals(btnScissors)){
            return GameUtils.TIES;
        }

        if(playerSelectedChoice.equals(btnScissors)&& computerSelectedChoice.equals(btnRock)){
            return GameUtils.LOSES_TO;
        }

        if(playerSelectedChoice.equals(btnPaper)&& computerSelectedChoice.equals(btnRock)){
            return GameUtils.BEATS;
        }

        if(playerSelectedChoice.equals(btnPaper)&& computerSelectedChoice.equals(btnPaper)){
            return GameUtils.TIES;
        }

        if(playerSelectedChoice.equals(btnPaper)&& computerSelectedChoice.equals(btnScissors)){
            return GameUtils.LOSES_TO;
        }
